...
function pedirJugada() {
  ...
  do {
    ...
    eleccion = parseInt(
      prompt("Ingrese para jugar: 1(piedra), 2(papel) o 3(tijera)")
    );
  ...
  switch (eleccion) {
    case 1:
      console.log(eleccion + " piedra");
      break;
    case 2:
      console.log(eleccion + " papel");
      break;
    case 3:
      console.log(eleccion + " tijera");
      break;
  }
  console.log("----------------------------");
...
function jugadaRandom() {
  ...
  switch (numero) {
    case 1:
      console.log(numero + " piedra");
      break;
    case 2:
      console.log(numero + " papel");
      break;
    case 3:
      console.log(numero + " tijera");
      break;
  }
  // console.log(numero);
  console.log("----------------------------");
...
function compararJugadas() {
  const RESULTADOS_POSIBLES = [
    { choice: 0, message: "¡Genial, ganaste!" },
    {
      choice: 1,
      message: "Esto fue un empate.",
    },
    {
      choice: 2,
      message: "Una lástima, perdiste.",
    },
  ];
...
function showMessage(message) {
  ...
  const goodMessage = "Buen intento, mejor suerte la próxima";
  if (message.choice === 2) {
...
showMessage(resultadoDePartida);
